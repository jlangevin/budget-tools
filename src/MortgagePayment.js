...
import { calculateLoanPayment, getValidDecimal } from './utils/loans.js';
...
class MortgagePayment extends Component {
  ...
  calculatePayment = () => {
    ...
    let stateUpdates = {
      ...
      payment        : ( typeof rate !== 'number' || typeof duration !== 'number' ) ?
                       '' : 
                       calculateLoanPayment(rate, duration, principal)
    };
  ...
  toggleTooltip = (tooltip) => {
    let isOpen = this.state[tooltip];
    this.setState({ [tooltip]: !isOpen });
  }
        ...
        <Form>
          <FormGroup row>
            ...
            <Tooltip
              ...
              isOpen    = { rateTipOpen }
              target    = 'rateLabel'
              toggle    = { () => this.toggleTooltip('rateTipOpen') }
            >
          ...
          <FormGroup row>
            ...
            <Tooltip
              ...
              toggle    = { () => this.toggleTooltip('durationTipOpen') }
            >
          ...
          <FormGroup row>
            ...
            <Tooltip
              ...
              toggle    = { () => this.toggleTooltip('principalTipOpen') }
            >
          ...
          <FormGroup row>
            <Col xs={ 12 } md={ 8 } lg={ 6 }>
              ...
              HOA dues, or other fees commonly associated with mortgages.
            </Col>
          </FormGroup>
        </Form>
      </Container>
